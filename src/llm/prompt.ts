  ...
  if (language === 'de') {
    return {
      systemInstruction: [
        ...
        '',
        'Die Ausgabe hat **zwei** Abschnitte: "Gestern" und "Heute". "Heute" verschmilzt offene Arbeit + heutige Termine zu einem sprechbaren Block.',
        '',
        'Regeln "Gestern":',
        ...
        '- Hinweise auf alte unangetastete Items ("PR liegt seit 5 Tagen") nur falls auffällig.',
        '',
        'Format:',
